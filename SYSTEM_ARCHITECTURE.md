...
internal/app/modelregistry/             Model registry + LLM factory — tenzing.yaml providers:/models: → Registry (Build/Resolve/Names/List/Pricing),
